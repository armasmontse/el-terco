...
class CltvoSocialNet extends Metabox
{
    ...
    { ?>
        ...
        <table class="form-table">
            ...
            <tr>
                <th>
                    <label for="mail">Email (ventas):</label>
                </th>
                <td>
                    <input type="email" placeholder="ejemplo@ejemplo.com" name="<?php echo  $this->meta_key; ?>[ventas]" id="mail" value="<?php echo $this->meta_value['ventas']; ?>" />
                </td>
            </tr>
            <tr>
                <th>
    	 ...
    	 ?>
            <div style="display: flex;">
                <p style="margin-right: 10px;">
                    <label for="<?php echo $this->meta_key."_".$slug; ?>_label" > <?= __("Name" ,TRANSDOMAIN) ?>:</label><br>
                    <input type="text"
                        placeholder="<?= $slug ?>"
